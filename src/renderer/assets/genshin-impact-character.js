export default {
  ...
  materials: {
    ...
    DvalinsClaw: 0,
    RingOfBoreas: 0,
    SpiritLocketOfBoreas: 0,
    TailOfBoreas: 0,
    ShadowOfTheWarrior: 0,
    ShardOfAFoulLegacy: 0,
    TushOfMonocerosCaeli: 0,
    DragonLordsCrown: 0,
    BloodjadeBranch: 0,
    GildedScale: 0,
    AshenHeart: 0,
    ...
    MoltenMoment: 0,
    TheMeaningOfAeons: 0,
    MudraOfTheMaleficGeneral: 0,
    TearsOfTheCalamitousGod: 0,
    PuppetStrings: 0,
    MirrorOfMushin: 0,
    DakasBell: 0,
    WorldspanFern: 0,
    PrimordialGreenbloom: 0,
    Everamber: 0,
  ...
  characters: {
    ...
    Traveler: {
      ...
      aptitudes: {
        ...
        Dendro: {
          normalAttack: {
            level: 1,
            material: 'MudraOfTheMaleficGeneral',
          },
          elementalSkill: {
            level: 1,
            constellationIncrease: 5,
    ...
    'Kuki Shinobu': {
      ...
      aptitudes: {
        normalAttack: {
          level: 1,
          material: 'TearsOfTheCalamitousGod',
        },
        elementalSkill: {
          level: 1,
          constellationIncrease: 3,
